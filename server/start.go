...
import (
	...
	"github.com/BFH-FinTech-Innovations-Ltd/BFH-EVM/cmd/bfhd/opendb"
	"github.com/BFH-FinTech-Innovations-Ltd/BFH-EVM/indexer"
	ethdebug "github.com/BFH-FinTech-Innovations-Ltd/BFH-EVM/rpc/namespaces/ethereum/debug"
...
`,
	...
	cmd.Flags().String(server.FlagMinGasPrices, "", "Minimum gas prices to accept for transactions; Any fee in a tx must meet this minimum (e.g. 20000000000ubfh)") //nolint:lll
	...
	cmd.Flags().Uint64(srvflags.JSONRPCGasCap, config.DefaultGasCap, "Sets a cap on gas that can be used in eth_call/estimateGas unit is ubfh (0=infinite)")                          //nolint:lll
